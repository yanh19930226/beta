...
namespace Resillience.Util.Clients
{
    ...
    public class HttpRequest : HttpRequestBase<IHttpRequest>, IHttpRequest
    {
        ...
        public async Task<TResult> ResultFromJsonAsync<TResult>() => Serializer.ToObject<TResult>(await ResultAsync());
    }
        ...
        where TResult : class
    {
        ...
        private TResult ConvertTo(string result, string contentType)
        {
            ...
            if (contentType.SafeString().ToLower() == "application/json")
                return Serializer.ToObject<TResult>(result);
            return null;
        }
        ...
        /// 获取Json结果
        /// </summary>
        public async Task<TResult> ResultFromJsonAsync() => Serializer.ToObject<TResult>(await ResultAsync());
    }
}
